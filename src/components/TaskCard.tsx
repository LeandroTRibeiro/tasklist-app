...
export const TaskCard = (data: PropsItem) => {
    ...
    return(
        ...
        <div className={`form-control border-2 rounded-lg py-5 px-10 shadow-xl flex justify-between gap-5 ${data.data.done ? 'opacity-50' : ''} ${theme.status ? '' : 'border-gray-800 bg-gray-700 text-gray-300'}`}>
